...
?>
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="pink">Beginners Handstands</h3>
				<p>
				...
				<p class="gold">
					<i><b>Handstands are fun, and really, really, good for you!</b></i>
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<h3 class="pink">Pole Handstands</h3>
				<p>
