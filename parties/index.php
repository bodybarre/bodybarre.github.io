...
?>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-12">
      				<h3 class="pink">Bodybarre Parties</h3>
      				<p>
                Our unique party packages are a great opportunity to get your friends and family together!
                Let us take the hassle out of planning your Hen Party, Birthday party, Girlie-get-together, Celebratory treat, or Night Out...
              </p>
              <p>
                Choose your lesson style from the options below. Can’t make up your mind? Too much to choose from? Then why not have a party mix of two different styles!
                No experience required as we will show you how.
              </p>
      				<p class="gold">
      					<i><b>Prepare to giggle yourself silly!</b></i>
      				</p>
            </div>
			    </div>
          <div class="row">
            <div class="col-md-12">
              <h3 class="pink">Where?</h3>
              <p>
				...
				<div class="col-md-6">
					<div class="row">
						<div class="col-md-12">
							...
							<p>
                Our parties are cheaper than you think!
              </p>
              <p>
                For a Bodybarre Dance party, we require a £50 booking fee (non-refundable)
                and an additional £20.00 per person payable on the day of your party.
              </p>
              <p>
                If not all of your party wish to participate but just wish to soak up the atmosphere then the spectator fee of £10.00 per person
                is payable on the day of your party.
              </p>
              <p>
...
Also available through our pole party package is the opportunity to book an extra special treat and be entertained by the Bodybarre professional dancers.  Whether you choose a female or male performer, or both; they will wow you with their fun and flirty routines. Please see costs for details on optional extras.
          </p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="pink">Burlesque Striptease Party</h3>
          <p>
            For all those who love to dress up come and explore our burlesque box of tricks. Raise your pulse with lap dancing techniques and shake your silhouette to that of a sex goddess. Learn how to flirt with feather boas and fans, peel the glove, ‘cheesecake’ burly facial expressions and sensual strip to reveal twirling tassels! Have fun as you build up a burlesque dance routine full of bump ‘n’ grind and shimmy. Explore your curves and feel great about yourself. A party packed with fun and giggles.
A sexy showcase!
          </p>
        </div>
      </div>
  ...
  A sassy showcase which is fabulous, flirty, and a little bit naughty.
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="pink">Cheerleading Party</h3>
          <p>
            Mini skirts and long socks at the ready, its time to make the squad. "Do a split, give a cheer, shake your pompoms, and your rear!!" A Cheerleading Party is filled with playful fun and high energy. Swap your feather boas for our sparkly Pom-Poms. Inspired by the American style of Cheerleading the focus is on big smiles and action packed dance combinations for which no experience is necessary. We add extra fabulousity with a custom made fun chant for you to deliver from the sidelines!
...
See our costs to book party optional extras and add Bodybarre's "Malerotic" dance performance to spice up your party with a touch of Johnny Castle! 
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="pink">Michael Jacksons Thriller Dance Party</h3>
          <p>
            Bring the 'wacko' and wonderful to your party. Learn the choreography to Michael Jackson's Thriller with a unique sexy twist; the results are hilarious. Create a party none of the guests will ever forget!
The Thriller Dance is the new fashion for a wedding reception.  Why not take the moves learnt from the party and show them off at the wedding evening celebrations and perform Michael Jacksons ‘Thriller’ Dance.
Our Thiller party package will build a routine to suit any dance level. No experience necessary.
...
A superb twist to your party, have a whirl of a time!
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="pink">Single Ladies Dance Party</h3>
          <p>
            Booty shaking sistas, you've seen the video now come and star in the hottest pop video as you learn to drop-it, pop-it, swing and shake-it!  A fun, all things girlie party package where black leotards are not compulsory; yet imagine how fabulous and funny it could be...  The routine is simplified to accommodate the non-dancer with the main focus on easy to follow, stylist steps. Release your inner pop star!
          </p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="pink">Twerking Dance Party</h3>
          <p>
